...
class Product:
    ...
    def __init__(self, window):
        ...
        # Price Input
        Label(frame, text = 'cant: ').grid(row = 3, column = 0)
        ...
        # Table
        #self.tree =  ttk.Treeview('#0,'#1', '#2', '#3')
